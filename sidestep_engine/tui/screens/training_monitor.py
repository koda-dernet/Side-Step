...
from sidestep_engine.tui.state import RunInfo
from sidestep_engine.tui.widgets.gpu_gauge import GPUGauge
from sidestep_engine.tui.widgets.loss_sparkline import LossSparkline
from sidestep_engine.tui.widgets.log_viewer import TrainingLogViewer
...
class TrainingMonitorScreen(Screen):
    ...
    def _run_training(self) -> None:  # NOTE: sync, not async
        ...
        try:
            ...
            from sidestep_engine.cli.common import resolve_target_modules
