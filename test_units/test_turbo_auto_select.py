...
class TestDiscreteTimestepSampling(unittest.TestCase):
    ...
    def test_output_shape(self):
        ...
        from sidestep_engine.core.timestep_sampling import sample_discrete_timesteps
...
class TestIsTurboDetection(unittest.TestCase):
    ...
    @patch("sidestep_engine.cli.config_builder._resolve_model_config_path")
    @patch("sidestep_engine.cli.config_builder.detect_gpu")
...
class TestWizardTurboDetection(unittest.TestCase):
    ...
    def test_base_model(self):
        ...
        self.assertFalse(is_turbo({"base_model": "sft", "num_inference_steps": 50}))

    def test_turbo_finetune_by_steps(self):
        from sidestep_engine.ui.flows.common import is_turbo

        self.assertTrue(is_turbo({"base_model": "my-finetune", "num_inference_steps": 8}))

    def test_non_turbo_finetune_by_steps(self):
        from sidestep_engine.ui.flows.common import is_turbo

        self.assertFalse(is_turbo({"base_model": "my-finetune", "num_inference_steps": 50}))
