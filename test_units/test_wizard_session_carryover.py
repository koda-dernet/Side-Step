...
class TestWizardSessionCarryover(unittest.TestCase):
    def test_session_defaults_carry_forward_between_actions(self) -> None:
        from sidestep_engine.ui import wizard
        ...
        with (
            ...
            patch("sidestep_engine.ui.wizard._main_menu", side_effect=_main_menu),
    ...
    def test_chain_training_uses_carried_context(self) -> None:
        ...
        with (
            ...
            patch("sidestep_engine.ui.wizard._ensure_first_run_done"),
            patch(
                "sidestep_engine.ui.wizard._main_menu",
                side_effect=[preprocess_ns, None],
            ),
            patch("sidestep_engine.ui.prompt_helpers.ask_bool", return_value=True),
            patch("sidestep_engine.ui.wizard.menu", return_value="lora"),
            patch("sidestep_engine.ui.wizard.wizard_train", side_effect=_wizard_train),
        ):
