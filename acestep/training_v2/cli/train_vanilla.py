...
# Wrap in try/except so Side-Step can still import this module
# (and show a clear error) when base ACE-Step is not installed.
try:
    from acestep.training.configs import LoRAConfig, TrainingConfig
    from acestep.training.trainer import LoRATrainer
    _VANILLA_AVAILABLE = True
except ImportError:
    from acestep.training_v2._vendor.configs import (  # type: ignore[no-redef]
        LoRAConfig,
        TrainingConfig,
    )
...
try:
    from acestep.training.configs import LoKRConfig  # type: ignore[no-redef]
    from acestep.training.trainer import LoKRTrainer
    _LOKR_AVAILABLE = True
except ImportError:
    from acestep.training_v2._vendor.configs import LoKRConfig  # type: ignore[no-redef]
