...
from acestep.training_v2.fisher.engine import single_fisher_run, _clear_cache
from acestep.training_v2.fisher.io import compute_dataset_hash, save_fisher_map
...
from acestep.training_v2.fisher.preview import ask_confirmation, print_preview
from acestep.training_v2.fisher.ranks import assign_ranks
from acestep.training_v2.fisher.spectral import compute_spectral_complexity
...
def _resolve_model_timestep_params(checkpoint_dir: str, variant: str) -> tuple[float, float, float]:
    ...
    timestep_mu, timestep_sigma, data_proportion = -0.4, 1.0, 0.5
...
def _make_subset_loader_factory(
    ...
    from acestep.training_v2._vendor.data_module import collate_preprocessed_batch
...
def run_fisher_analysis(
    ...
    from acestep.training_v2.gpu_utils import detect_gpu, get_available_vram_mb
