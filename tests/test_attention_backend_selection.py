...
class TestAttentionBackendSelection(unittest.TestCase):
    ...
    def test_cpu_device_skips_flash_attention(self) -> None:
        from acestep.training_v2.model_loader import _flash_attention_unavailable_reason
    ...
    def test_candidate_list_starts_with_sdpa_when_fa2_unavailable(self) -> None:
        from acestep.training_v2.model_loader import _choose_attention_candidates

        with patch(
            "acestep.training_v2.model_loader._flash_attention_unavailable_reason",
