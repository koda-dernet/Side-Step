...
class TestTrainingReviewFlow(unittest.TestCase):
    def test_review_menu_can_jump_to_training_section(self) -> None:
        from acestep.training_v2.ui import flows_train
        ...
        with patch("acestep.training_v2.ui.flows_train.menu", return_value="edit_training"):
    ...
    def test_review_cancel_raises_goback(self) -> None:
        ...
        with patch("acestep.training_v2.ui.flows_train.menu", return_value="cancel"):
            with self.assertRaises(GoBack):
                flows_train._review_and_confirm(answers, "basic", steps)

    def test_check_fisher_map_marks_recommendation_without_running_analysis(self) -> None:
        from acestep.training_v2.ui import flows_train
